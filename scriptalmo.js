...
produtos.forEach(produto => {
    ...
    const codigoProduto = produto.querySelector('.codigo').textContent;
    ...
    btnRemover.addEventListener('click', () => {
        if (quantidade > 0) {
            const quantidadeRemovida = quantidade;
            ...
            btnBaixarPDF.addEventListener('click', () => {
                ...
                const codigoText = `Código: ${codigoProduto}`;
                ...
                doc.text(codigoText, startX, 40, { align: 'center' });
                doc.text(qtdRetiradaText, startX, 50, { align: 'center' });
                doc.text(qtdRestanteText, startX, 60, { align: 'center' });
                doc.text(dataHoraText, startX, 70, { align: 'center' });
